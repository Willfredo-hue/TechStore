...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const btnVerLogin = document.getElementById("btnVerLoginPassword");
    const iconoLogin = btnVerLogin.querySelector("i");


    if(btnVerLogin && passwordLogin){
        ...
        btnVerLogin.addEventListener("click", () => {
            ...
            if(passwordLogin.type === "password"){
                ...
                iconoLogin.classList.remove("bi-eye-slash");
                iconoLogin.classList.add("bi-eye");
                ...
                iconoLogin.classList.remove("bi-eye");
                iconoLogin.classList.add("bi-eye-slash");
